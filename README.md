...
1. Clone this repository
   ```bash
   git clone https://github.com/z-mahmud22/Mask-RCNN_TF-keras-2.14.0.git
   ```
**Recommended way:**
...
3. Run setup from the repository root directory
    ...
    ```
3. Download pre-trained COCO weights (mask_rcnn_coco.h5) from the [releases page]([https://github.com/matterport/Mask_RCNN/releases](https://github.com/matterport/Mask_RCNN/releases/download/v2.0/mask_rcnn_coco.h5)).
